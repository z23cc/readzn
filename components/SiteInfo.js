  ...
  return (
    <div className={styles.siteInfoSection}>
      <div className={styles.siteInfoContent}>
        <h3 className={styles.siteInfoTitle}>本站开源</h3>
        <p className={styles.siteInfoText}>本网站采用 <span className={styles.siteInfoHighlight}>MIT开源协议</span>，您可以自由使用、修改和分发本站代码，非常适合学习和个人项目使用。</p>
