...
try {
  ...
  if (fs.existsSync(configPath)) {
    ...
    console.warn('Warning: blog.config.js not found at', configPath)
    // Provide fallback configuration or load from another location
    const fallbackPath = resolve(__dirname, '../../blog.config.js')
