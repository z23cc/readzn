      ...
      <div className={styles.contactContainer}>
        <div className={styles.contactHeader}>
          ...
          <div className={styles.aboutUs}>
            ...
            <p>我们欢迎大家投稿至 <a href="https://github.com/z23cc/readzn/issues" target="_blank" rel="noopener noreferrer" className={styles.siteInfoHighlight} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>Github Issues</a>，提交任何您认为对读者有帮助的资源。为确保质量，内容会在审核通过后收录到平台。</p>
          </div>
        </div>
