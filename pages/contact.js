      ...
      <div className={styles.contactContainer}>
        <div className={styles.contactHeader}>
          ...
          <div className={styles.aboutUs}>
            <h2>建站初衷</h2>
            <p>本站创立于2025年，源于对「知识无界，阅读无限」的执着追求，致力于打造一个解决阅读烦恼的一站式平台。我们关注阅读爱好者们的核心需求：</p>
            <ul>
            ...
            <p>我们使命是：通过精选全球优质阅读资源和开发开源精品工具，为人们带来愉悦、高效的阅读体验。</p>
            <h2>欢迎投稿</h2>
            ...
            <p>我们欢迎大家投稿至 <a href="https://github.com/ChrisHyperFunc/readzn/issues" target="_blank" rel="noopener noreferrer" className={styles.siteInfoHighlight} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>Github Issues</a>，提交任何您认为对读者有帮助的资源。为确保质量，内容会在审核通过后收录到平台。</p>
          </div>
        </div>
